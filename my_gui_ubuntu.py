...
# Form implementation generated from reading ui file 'sample_ubuntu.ui'
#
...
class Ui_SplitDownloader(object):
    def setupUi(self, SplitDownloader):
        ...
        self.button_exit.setGeometry(QtCore.QRect(290, 400, 75, 23))
        ...
        self.label_part_select.setGeometry(QtCore.QRect(10, 90, 71, 21))
        ...
        self.combo_partselect.setGeometry(QtCore.QRect(90, 90, 451, 22))
        ...
        self.label_file_size_output.setGeometry(QtCore.QRect(150, 60, 61, 16))
        ...
        self.label_url.setGeometry(QtCore.QRect(10, 20, 51, 20))
        self.label_url.setObjectName("label_url")
        self.label_folder_path_download = QtWidgets.QLabel(self.tab_download)
        self.label_folder_path_download.setGeometry(QtCore.QRect(10, 130, 71, 21))
        ...
        self.label_chunk_size.setGeometry(QtCore.QRect(390, 60, 71, 16))
        self.label_chunk_size.setObjectName("label_chunk_size")
        self.label_MB = QtWidgets.QLabel(self.tab_download)
        self.label_MB.setGeometry(QtCore.QRect(540, 60, 21, 16))
        ...
        self.lineedit_chunk_size.setGeometry(QtCore.QRect(470, 60, 61, 20))
        self.lineedit_chunk_size.setObjectName("lineedit_chunk_size")
        self.checkBox = QtWidgets.QCheckBox(self.tab_download)
        self.checkBox.setEnabled(False)
        self.checkBox.setGeometry(QtCore.QRect(250, 60, 111, 17))
        ...
        self.label_merge_path_merge.setGeometry(QtCore.QRect(10, 100, 71, 16))
        ...
        self.label_folder_path_merge_3.setGeometry(QtCore.QRect(10, 60, 81, 16))
        self.label_folder_path_merge_3.setObjectName("label_folder_path_merge_3")
        self.button_browse_folder_merge = QtWidgets.QPushButton(self.tab_merge)
        self.button_browse_folder_merge.setGeometry(QtCore.QRect(550, 60, 75, 23))
        self.button_browse_folder_merge.setObjectName("button_browse_folder_merge")
        ...
        self.label_config_file_merge.setGeometry(QtCore.QRect(10, 20, 71, 16))
        ...
        self.line_edit_config.setGeometry(QtCore.QRect(100, 20, 441, 20))
        self.line_edit_config.setObjectName("line_edit_config")
        self.line_edit_folder_merge = QtWidgets.QLineEdit(self.tab_merge)
        self.line_edit_folder_merge.setGeometry(QtCore.QRect(100, 60, 441, 20))
        ...
        self.line_edit_merge_path_merge.setGeometry(QtCore.QRect(100, 100, 441, 20))
        ...
        self.line_edit_out_path_split.setGeometry(QtCore.QRect(90, 110, 451, 20))
        self.line_edit_out_path_split.setObjectName("line_edit_out_path_split")
        self.label_file_size_output_split = QtWidgets.QLabel(self.tab_split)
        self.label_file_size_output_split.setGeometry(QtCore.QRect(150, 80, 61, 16))
        self.label_file_size_output_split.setAlignment(QtCore.Qt.AlignCenter)
        self.label_file_size_output_split.setObjectName("label_file_size_output_split")
        self.label_chunk_size_split = QtWidgets.QLabel(self.tab_split)
        self.label_chunk_size_split.setGeometry(QtCore.QRect(360, 80, 71, 16))
        self.label_chunk_size_split.setObjectName("label_chunk_size_split")
        self.label_file_size_split = QtWidgets.QLabel(self.tab_split)
        self.label_file_size_split.setGeometry(QtCore.QRect(90, 80, 47, 13))
        self.label_file_size_split.setObjectName("label_file_size_split")
        self.label_MB_2 = QtWidgets.QLabel(self.tab_split)
        self.label_MB_2.setGeometry(QtCore.QRect(520, 80, 21, 16))
        self.label_MB_2.setObjectName("label_MB_2")
        self.lineedit_chunk_size_split = QtWidgets.QLineEdit(self.tab_split)
        self.lineedit_chunk_size_split.setEnabled(False)
        self.lineedit_chunk_size_split.setGeometry(QtCore.QRect(440, 80, 71, 20))
        self.lineedit_chunk_size_split.setObjectName("lineedit_chunk_size_split")
    ...
    def retranslateUi(self, SplitDownloader):
        ...
        self.checkBox.setText(_translate("SplitDownloader", "Split Download"))
        ...
        self.button_browse_folder_merge.setText(_translate("SplitDownloader", "Browse"))
        ...
        self.button_browse_out_pt_split.setText(_translate("SplitDownloader", "Browse"))
        ...
        self.label_file_size_output_split.setText(_translate("SplitDownloader", "--"))
        self.label_chunk_size_split.setText(_translate("SplitDownloader", "Chunk Size :"))
        self.label_file_size_split.setText(_translate("SplitDownloader", "File Size :"))
        self.label_MB_2.setText(_translate("SplitDownloader", "MB"))
